...
import com.ppc.simplejson.parser.Token;
import com.ppc.simplejson.parser.TokenList;
import com.ppc.simplejson.parser.TokenTypeEnum;
...
public class Parser {
    ...
    private Object parse() {
        ...
        } else if (token.getTokenType() == TokenTypeEnum.BEGIN_ARRAY) {
            return parseJsonArray();
        } else {
            return new JsonParseException("Parse error, invalid token.");
        }
    }
    ...
    private JsonObject parseJsonObject() {
        ...
        while (tokenList.hasMore()) {
            ...
            switch (tokenType) {
                ...
                case STRING:
                    checkExpectToken(tokenType, expectToken);
                    Token preToken = tokenList.peekPrevious();
                    /**
